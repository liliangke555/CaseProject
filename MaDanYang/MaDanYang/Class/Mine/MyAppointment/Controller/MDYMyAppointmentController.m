...
@interface MDYMyAppointmentController ()<JXCategoryViewDelegate,JXCategoryListContainerViewDelegate>
...
@implementation MDYMyAppointmentController
...
- (void)viewDidLoad {
    ...
    self.titles = [NSMutableArray arrayWithArray:@[@"全部", @"审核中", @"待上门"]];
...
- (id<JXCategoryListContentViewDelegate>)listContainerView:(JXCategoryListContainerView *)listContainerView initListForIndex:(NSInteger)index {
    MDYMyAppointmentListController *vc = [[MDYMyAppointmentListController alloc] init];
    vc.type = index;
    return vc;
}
#pragma mark - Getter
