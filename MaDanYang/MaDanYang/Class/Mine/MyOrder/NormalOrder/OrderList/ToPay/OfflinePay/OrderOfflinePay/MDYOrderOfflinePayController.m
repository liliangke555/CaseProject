//
//  MDYOrderOfflinePayController.m
//  MaDanYang
//
...
@interface MDYOrderOfflinePayController ()
@property (nonatomic, strong) UIImageView *photoImageView;
@end

@implementation MDYOrderOfflinePayController
...
- (void)createView {
    ...
    [scrollView setContentSize:CGSizeMake(0, 485 + self.orderModel.order_goods.count * 156)];
    
    UIView *contentView = [[UIView alloc] init];
    [scrollView addSubview:contentView];
    contentView.frame  = CGRectMake(0, 0, CK_WIDTH, 485 + self.orderModel.order_goods.count * 156);
    
    MASViewAttribute *lastAttribute = contentView.mas_top;
    
    for (int i = 0; i < self.orderModel.order_goods.count; i ++) {
        MDYOrderInfoGoodsModel *model = self.orderModel.order_goods[i];
        ...
        [headerImageView sd_setImageWithURL:[NSURL URLWithString:model.goods_img]];
        ...
        [moneyLabel setText:[NSString stringWithFormat:@"实付：¥ %@",model.goods_price]];
        ...
        [numLabel setText:[NSString stringWithFormat:@"X %@",model.goods_num]];
        [numLabel setFont:KSystemFont(14)];
        [numLabel setTextColor:K_TextGrayColor];
    ...
    [timeDetailLabel setText:self.orderTime];
