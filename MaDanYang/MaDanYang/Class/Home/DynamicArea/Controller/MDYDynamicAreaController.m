...
@interface MDYDynamicAreaController ()<UICollectionViewDelegate,UICollectionViewDataSource,DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) NSMutableArray *dataSource;
@property (nonatomic, assign) NSInteger pageNum;
@end

@implementation MDYDynamicAreaController
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        ...
        tempHeaderView.title = @"全部晒单";
        tempHeaderView.subTitle = @"只看优质";
        CKWeakify(self);
        [tempHeaderView setDidClickButton:^{
            MDYHighDynamicController *vc= [[MDYHighDynamicController alloc] init];
